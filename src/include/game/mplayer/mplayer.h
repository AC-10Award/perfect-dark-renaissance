...
// Temporary LMS result-screen test shortcut. Remove or set to 0 after Win/Lose UI is verified.
#define MP_LMS_DEBUG_QUICK_RESULTS 0
...
#define MPTRACK_RANDOM -1
#define MPTRACK_NONE   -2
