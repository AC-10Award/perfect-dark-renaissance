...
#else
extern struct headorbody g_HeadsAndBodies[233];
#endif
...
#else // PD Plus Mod
extern struct mphead g_MpHeads[VERSION == VERSION_JPN_FINAL ? 119 : 120];
#endif
extern struct botprofile g_BotProfiles[18];
#ifdef PLATFORM_N64
extern struct mpbody g_MpBodies[61];
#else // PD Plus Mod
extern struct mpbody g_MpBodies[112];
#endif
...
extern s32 g_OneHitBots;
extern s32 g_MpSpHitReactions;
extern s32 g_MpPickupRespawnSpeed;
extern s32 g_MpPickupRespawnSfx;
