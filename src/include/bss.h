...
extern struct chrdata *g_MpAllChrPtrs[MAX_MPCHRS_RUNTIME];
extern struct mpchrconfig *g_MpAllChrConfigPtrs[MAX_MPCHRS_RUNTIME];
extern s32 g_MpNumChrs;
extern struct mpbotconfig g_BotConfigsArray[MAX_BOTS_RUNTIME];
extern u8 g_MpSimulantDifficultiesPerNumPlayers[MAX_BOTS_RUNTIME][MAX_PLAYERS];
...
extern struct chrdata *g_MpBotChrPtrs[MAX_BOTS_RUNTIME];
