...
struct weapon invitem_falcon2 = {
	...
	NULL, // pritosec animation
	NULL, // sectopri animation
	{ &invfunc_falcon2_singleshot, &invfunc_falcon2silenced_singleshot }, // functions
...
#else
	MD_WEAPON_TEXT_FALCON2, // short name
#endif
	MD_WEAPON_TEXT_FALCON2, // name
...
struct weapon invitem_falcon2scope = {
	...
	MD_WEAPON_TEXT_FALCON2_SCOPE, // name
	L_GUN_150, // manufacturer
...
struct weapon invitem_falcon2silencer = {
	...
	MD_WEAPON_TEXT_FALCON2_SILENCER, // name
	L_GUN_150, // manufacturer
...
struct guncmd invanim_matrix85_shoot[] = {
	gunscript_playanimation(ANIM_GUN_MAGSEC4_SHOOT, 0, 10000)
	gunscript_playsound(1, SFX_007F)
	gunscript_waittime(12, 5)
	gunscript_end
};
...
struct weaponfunc_shootsingle invfunc_matrix85_singleshot = {
	INVENTORYFUNCTYPE_SHOOT_SINGLE,
	L_GUN_085, // name
	0, // unused
	0, // ammoindex
	&invnoisesettings_default,
	invanim_matrix85_shoot, // fire animation
	0, // flags
	&invrecoilsettings_default,
	16, // recoverytime60
	1.1, // damage
...
struct weaponfunc_shootauto invfunc_matrix85_rapidfire = {
...
struct inventory_ammo invammo_matrix85 = {
	AMMOTYPE_PISTOL,
	CASING_STANDARD,
	20, // clip size
	invanim_magsec_reload, // reload animation
...
struct weapon invitem_dy357 = {
	...
	MD_WEAPON_TEXT_DY357_MAGNUM, // name
...
struct weapon invitem_dy357lx = {
	...
	gunviscmds_magnum, // gunviscmds
	invpartvisibility_dy357, // part visibility
	MD_WEAPON_TEXT_DY357_LX, // short name
	MD_WEAPON_TEXT_DY357_LX, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_phoenix = {
	...
	MD_WEAPON_TEXT_PHOENIX, // short name
	MD_WEAPON_TEXT_PHOENIX, // name
...
struct weapon invitem_mauler = {
	...
	MD_WEAPON_TEXT_MAULER, // short name
	MD_WEAPON_TEXT_MAULER, // name
...
struct weapon invitem_cmp150 = {
	...
	MD_WEAPON_TEXT_CMP150, // short name
	MD_WEAPON_TEXT_CMP150, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_cyclone = {
	...
	MD_WEAPON_TEXT_CYCLONE, // short name
	MD_WEAPON_TEXT_CYCLONE, // name
	L_GUN_151, // manufacturer
...
struct weapon invitem_rcp120 = {
	...
	MD_WEAPON_TEXT_RCP120, // short name
	MD_WEAPON_TEXT_RCP120, // name
	L_GUN_151, // manufacturer
...
struct weapon invitem_callisto = {
	...
	MD_WEAPON_TEXT_CALLISTO_NTG, // short name
	MD_WEAPON_TEXT_CALLISTO_NTG, // name
	L_GUN_153, // manufacturer
...
struct weapon invitem_dragon = {
	...
	MD_WEAPON_TEXT_DRAGON, // short name
	MD_WEAPON_TEXT_DRAGON, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_superdragon = {
	...
	MD_WEAPON_TEXT_SUPERDRAGON, // short name
	MD_WEAPON_TEXT_SUPERDRAGON, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_ar34 = {
	...
	MD_WEAPON_TEXT_AR34, // short name
	MD_WEAPON_TEXT_AR34, // name
	L_GUN_000, // manufacturer
...
struct weapon invitem_k7avenger = {
	...
	MD_WEAPON_TEXT_K7_AVENGER, // short name
	MD_WEAPON_TEXT_K7_AVENGER, // name
	L_GUN_149, // manufacturer
...
#else
	MD_WEAPON_TEXT_LAPTOP_GUN, // short name
#endif
	MD_WEAPON_TEXT_LAPTOP_GUN, // name
	L_GUN_150, // manufacturer
...
#else
	MD_WEAPON_TEXT_SHOTGUN, // short name
#endif
	MD_WEAPON_TEXT_SHOTGUN, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_reaper = {
	...
	MD_WEAPON_TEXT_REAPER, // short name
	MD_WEAPON_TEXT_REAPER, // name
	L_GUN_152, // manufacturer
...
struct weapon invitem_devastator = {
	...
	MD_WEAPON_TEXT_DEVASTATOR, // short name
	MD_WEAPON_TEXT_DEVASTATOR, // name
	L_GUN_149, // manufacturer
...
struct weapon invitem_farsight = {
	...
	MD_WEAPON_TEXT_FARSIGHT_XR20, // name
	L_GUN_000, // manufacturer
...
#else
	MD_WEAPON_TEXT_SNIPER_RIFLE, // short name
#endif
	MD_WEAPON_TEXT_SNIPER_RIFLE, // name
	L_GUN_000, // manufacturer
...
struct weaponfunc_shootauto invfunc_dmc_silenced_shoot = {
	INVENTORYFUNCTYPE_SHOOT_AUTOMATIC,
	L_GUN_146, // name
	0, // unused
	0, // ammoindex
...
struct weapon invitem_dmc = {
	...
	NULL, // pritosec animation
	NULL, // sectopri animation
	{ &invfunc_dmc_shoot, &invfunc_dmc_silenced_shoot }, // functions
	...
	L_GUN_000, // manufacturer
	L_GUN_000, // description
	WEAPONFLAG_00000004 | WEAPONFLAG_ONEHANDED | WEAPONFLAG_AICANUSE | WEAPONFLAG_DUALFLIP | WEAPONFLAG_00000040 | WEAPONFLAG_TRACKTIMEUSED | WEAPONFLAG_00000400 | WEAPONFLAG_DUALWIELD | WEAPONFLAG_00008000 | WEAPONFLAG_00002000,
};
...
struct weapon invitem_matrix85 = {
	FILE_GTESTGUN, // independent copy of the MagSec model
	FILE_GTESTGUN, // independent copy of the MagSec model
	invanim_matrix85_shoot, // equip animation
	NULL, // unequip animation
	NULL, // pritosec animation
	NULL, // sectopri animation
	{ &invfunc_matrix85_singleshot, &invfunc_matrix85_rapidfire }, // functions
	&invammo_matrix85, // pri ammo
	NULL, // sec ammo
	&invaimsettings_magsec4,
	2, // muzzlez
	10.5, // posx
	...
	gunviscmds_magsec, // gunviscmds
	invpartvisibility_magsec, // part visibility
	MD_WEAPON_TEXT_MATRIX85, // short name
	MD_WEAPON_TEXT_MATRIX85, // name
	L_GUN_151, // manufacturer
	L_GUN_159, // description
	WEAPONFLAG_00000004 | WEAPONFLAG_ONEHANDED | WEAPONFLAG_AICANUSE | WEAPONFLAG_DUALFLIP | WEAPONFLAG_00000040 | WEAPONFLAG_TRACKTIMEUSED | WEAPONFLAG_00000400 | WEAPONFLAG_DUALWIELD | WEAPONFLAG_00002000 | WEAPONFLAG_00004000 | WEAPONFLAG_HASHANDS | WEAPONFLAG_GANGSTA,
};
