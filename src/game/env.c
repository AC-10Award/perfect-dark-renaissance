...
struct sun suns_carpark_day[] = { 1, RGB(0xfff6d0), -650000, 350000, 850000, 24, 56 };
...
struct nofogenvironment g_NoFogEnvironments[] = {
	...
	{ STAGE_MP_CARPARK,    15, 12000,   0,  0,  0, RGB(0x7fb8ff), SUNS(suns_carpark_day), 1, RGB(0xf6f8ff), 5500,   0, 0, RGB(0x000000),  -5000,    0, 0, 0 },
#ifdef PLATFORM_N64
