...
struct aibotweaponpreference g_AibotWeaponPreferences[] = {
	...
	/*0x33*/ { 76,  88,  104, 120, 1, 1, BOTDISTCFG_PISTOL,         BOTDISTCFG_DEFAULT,        30,            30,  10, 10, 1, 0 }, // MD_WEAPON_MATRIX85
...
static bool botinvIsTerminationScenarioBoss(struct chrdata *chr)
{
...
void botinvTick(struct chrdata *chr)
{
	...
	if (botinvIsTerminationScenarioBoss(chr)) {
		return;
	}
