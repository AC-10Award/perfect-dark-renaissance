...
static MenuItemHandlerResult menuhandlerUnlockMpOnly(s32 operation, struct menuitem *item, union handlerdata *data)
{
	if (operation == MENUOP_SET) {
		gamefileUnlockMpFeatures();
	}
...
struct menuitem g_CheatsConfirmMpUnlockMenuItems[] = {
	{
		MENUITEMTYPE_LABEL,
		0,
		MENUITEMFLAG_LITERAL_TEXT,
		(uintptr_t)"Are you sure?\n\nThis will unlock multiplayer items\nfor the current profile without\nmarking campaign or challenges complete.\n",
		0,
		NULL,
	},
	{
	...
	},
	{
		...
		0,
		MENUITEMFLAG_SMALLFONT | MENUITEMFLAG_MARQUEE_FADEBOTHSIDES | MENUITEMFLAG_LITERAL_TEXT,
		(uintptr_t)"Unlocks multiplayer maps, weapons, simulants and options only.\n",
		0,
		NULL,
	},
	{
	...
	},
	{
		...
		L_OPTIONS_190, // "Yes"
		0,
		menuhandlerUnlockMpOnly,
	},
	{ MENUITEMTYPE_END },
};

struct menudialogdef g_CheatsConfirmMpUnlockMenuDialog = {
	MENUDIALOGTYPE_DANGER,
	L_OPTIONS_188, // "Warning"
	g_CheatsConfirmMpUnlockMenuItems,
	NULL,
	0,
	NULL,
};
...
struct menuitem g_CheatsMenuItems[] = {
...
#ifndef PLATFORM_N64
	{
		...
		(uintptr_t)"Unlock MP Options Only\n",
		0,
		(void *)&g_CheatsConfirmMpUnlockMenuDialog,
	},
	{
		MENUITEMTYPE_SELECTABLE,
		0,
