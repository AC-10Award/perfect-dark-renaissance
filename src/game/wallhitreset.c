...
void wallhitReset(void)
{
	...
	switch (type) {
	case 0:
		// Raise MP budgets so bot-heavy matches keep blood and impact effects alive longer.
		g_WallhitsMax = 240;
		g_MinPropWallhits = 30;
		g_MaxPropWallhits = 100;
		g_MinBgWallhitsPerRoom = 4;
		g_MaxBgWallhitsPerRoom = 50;
		var8009cc6c = 80;
		g_WallhitsCriticalSpareLimit = 20;
		g_WallhitsGoalSpareLimit = 35;
