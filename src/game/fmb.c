...
static const char g_FilemgrProfileMenuTitle4Mb[] = "PERFECT DARK RENAISSANCE v1.1\n";
static const char g_FilemgrProfileMenuSubtitle4Mb[] = "Choose a Game Profile\n";
...
struct menuitem g_FilemgrFileSelect4MbMenuItems[] = {
	{
		...
		(uintptr_t)g_FilemgrProfileMenuSubtitle4Mb,
		0,
		NULL,
	},
	{
...
struct menudialogdef g_FilemgrFileSelect4MbMenuDialog = {
	MENUDIALOGTYPE_DEFAULT,
	(uintptr_t)g_FilemgrProfileMenuTitle4Mb,
