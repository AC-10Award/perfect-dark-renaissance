...
Gfx *menugfxRenderBgStatic(Gfx *gdl, u32 colour)
{
	Col *colours;
	Vtx *vertices;
	const s32 width = viGetWidth();
	const s32 height = viGetHeight();
	const s32 texs = g_TexGeneralConfigs[6].width << 5;
	const s32 text = g_TexGeneralConfigs[6].height << 5;
	...
	vertices[0].y = 0;
	vertices[0].z = -10;
	vertices[1].x = width * 10;
	vertices[1].y = 0;
	vertices[1].z = -10;
	vertices[2].x = width * 10;
	vertices[2].y = height * 10;
	vertices[2].z = -10;
	vertices[3].x = 0;
	vertices[3].y = height * 10;
	vertices[3].z = -10;
