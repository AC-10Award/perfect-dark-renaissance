...
void texLoad(texnum_t *updateword, struct texpool *pool, bool unusedarg)
{
	...
	if ((*updateword & 0xffff0000) == 0 || (*updateword & 0xffff0000) == 0xabcd0000) {
		...
		if (tex == NULL) {
			...
			{
#ifndef PLATFORM_N64
				if (g_TexNumToLoad >= g_NumStockTextures) {
					return;
				}
#endif
...
#ifndef PLATFORM_N64
			extTexRegisterGeneralPtr(tex->data, bytesout, g_TexNumToLoad);
#endif
...
#ifndef PLATFORM_N64
				extTexRegisterGeneralPtr(pool->rightpos->data, bytesout, g_TexNumToLoad);
#endif
