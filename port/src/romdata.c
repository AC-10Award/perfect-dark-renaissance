...
#ifndef PLATFORM_N64
#define SET_EXTERNAL_SLOT(slot, filename) \
	fileSlots[MOD_NORMAL][slot].data = 0; \
	fileSlots[MOD_NORMAL][slot].size = 0; \
	fileSlots[MOD_NORMAL][slot].source = SRC_UNLOADED; \
	fileSlots[MOD_NORMAL][slot].preprocessed = 0; \
	fileSlots[MOD_NORMAL][slot].name = filename; \
	fileSlots[MOD_GEX][slot] = fileSlots[MOD_NORMAL][slot]; \
	fileSlots[MOD_KAKARIKO][slot] = fileSlots[MOD_NORMAL][slot]; \
	fileSlots[MOD_DARKNOON][slot] = fileSlots[MOD_NORMAL][slot]; \
	fileSlots[MOD_GOLDFINGER_64][slot] = fileSlots[MOD_NORMAL][slot]

	SET_EXTERNAL_SLOT(FILE_CHEADNATALYAZ, "CheadnatalyaZ");
	SET_EXTERNAL_SLOT(FILE_CNATALYAZ, "CnatalyaZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_JOFROCKZ, "Ghand_jofrockZ");
	SET_EXTERNAL_SLOT(FILE_CHEADXENIAZ, "CheadxeniaZ");
	SET_EXTERNAL_SLOT(FILE_CXENIAZ, "CxeniaZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_XENIAZ, "Ghand_xeniaZ");
	SET_EXTERNAL_SLOT(FILE_CHEADOURUMOVZ, "CheadourumovZ");
	SET_EXTERNAL_SLOT(FILE_COURUMOVZ, "CourumovZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_OURUMOVZ, "Ghand_ourumovZ");
	SET_EXTERNAL_SLOT(FILE_CHEADODDJOBZ, "CheadoddjobZ");
	SET_EXTERNAL_SLOT(FILE_CODDJOBZ, "CoddjobZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_ODDJOBZ, "Ghand_oddjobZ");
	SET_EXTERNAL_SLOT(FILE_CHEADTREVELYANZ, "CheadtrevelyanZ");
	SET_EXTERNAL_SLOT(FILE_CTREVELYANZ, "CtrevelyanZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_TREVELYANZ, "Ghand_trevelyanZ");
	SET_EXTERNAL_SLOT(FILE_CSPICEBONDZ, "CspicebondZ");
	SET_EXTERNAL_SLOT(FILE_CHEADBROSNANZ, "CheadbrosnanZ");
	SET_EXTERNAL_SLOT(FILE_CDJBOND2Z, "Cdjbond2Z");
	SET_EXTERNAL_SLOT(FILE_GHAND_BONDZ, "Ghand_bondZ");
	SET_EXTERNAL_SLOT(FILE_CHEADDALTONZ, "CheaddaltonZ");
	SET_EXTERNAL_SLOT(FILE_CDALTON2Z, "Cdalton2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADCONNERYZ, "CheadconneryZ");
	SET_EXTERNAL_SLOT(FILE_CCONNERY2Z, "Cconnery2Z");
	SET_EXTERNAL_SLOT(FILE_GHAND_BONDWHITEZ, "Ghand_bondwhiteZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMOOREZ, "CheadmooreZ");
	SET_EXTERNAL_SLOT(FILE_CMOORE2Z, "Cmoore2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADLAZENBYZ, "CheadlazenbyZ");
	SET_EXTERNAL_SLOT(FILE_CLAZENBYZ, "ClazenbyZ");
	SET_EXTERNAL_SLOT(FILE_CHEADJAWSZ, "CheadjawsZ");
	SET_EXTERNAL_SLOT(FILE_CJAWSZ, "CjawsZ");
	SET_EXTERNAL_SLOT(FILE_CHEADSNOWGUARDZ, "CheadsnowguardZ");
	SET_EXTERNAL_SLOT(FILE_CSNOWGUARDZ, "CsnowguardZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_SNOWGUARDZ, "Ghand_snowguardZ");
	SET_EXTERNAL_SLOT(FILE_CHEADBROSNAN2Z, "Cheadbrosnan2Z");
	SET_EXTERNAL_SLOT(FILE_CSNOWBONDZ, "CsnowbondZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMISHKINZ, "CheadmishkinZ");
	SET_EXTERNAL_SLOT(FILE_CGREATGUARDZ, "CgreatguardZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_MISHKINZ, "Ghand_mishkinZ");
	SET_EXTERNAL_SLOT(FILE_CSUITBONDZ, "CsuitbondZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_BLUE_SUITZ, "Ghand_blue_suitZ");
	SET_EXTERNAL_SLOT(FILE_CBOILERBONDZ, "CboilerbondZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_BLACKSTEALTHZ, "Ghand_blackstealthZ");
	SET_EXTERNAL_SLOT(FILE_CBOILERTREVZ, "CboilertrevZ");
	SET_EXTERNAL_SLOT(FILE_CTIMBERBONDZ, "CtimberbondZ");
	SET_EXTERNAL_SLOT(FILE_CHEADBORISZ, "CheadborisZ");
	SET_EXTERNAL_SLOT(FILE_CBORISZ, "CborisZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_BORISZ, "Ghand_borisZ");
	SET_EXTERNAL_SLOT(FILE_CHEADVALENTINZ, "CheadvalentinZ");
	SET_EXTERNAL_SLOT(FILE_CVALENTINZ, "CvalentinZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMAYDAYZ, "CheadmaydayZ");
	SET_EXTERNAL_SLOT(FILE_CMAYDAYZ, "CmaydayZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_MAYDAYZ, "Ghand_maydayZ");
	SET_EXTERNAL_SLOT(FILE_CHEADBARONSAMEDIZ, "CheadbaronsamediZ");
	SET_EXTERNAL_SLOT(FILE_CBARONSAMEDIZ, "CbaronsamediZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_SAMEDIZ, "Ghand_samediZ");
	SET_EXTERNAL_SLOT(FILE_CHEADBARONSAMEDI2Z, "Cheadbaronsamedi2Z");
	SET_EXTERNAL_SLOT(FILE_CBARONSAMEDI2Z, "Cbaronsamedi2Z");
	SET_EXTERNAL_SLOT(FILE_GHAND_SAMEDI2Z, "Ghand_samedi2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADSANTAZ, "CheadsantaZ");
	SET_EXTERNAL_SLOT(FILE_CSANTAZ, "CsantaZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_SANTAZ, "Ghand_santaZ");
	SET_EXTERNAL_SLOT(FILE_CHEADELFZ, "CheadelfZ");
	SET_EXTERNAL_SLOT(FILE_CELFZ, "CelfZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_ELFZ, "Ghand_elfZ");
	SET_EXTERNAL_SLOT(FILE_CHEADPILOTZ, "CheadpilotZ");
	SET_EXTERNAL_SLOT(FILE_CPILOTZ, "CpilotZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_PILOTZ, "Ghand_pilotZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMARIONZ, "CheadmarionZ");
	SET_EXTERNAL_SLOT(FILE_CFATTECHWOMANZ, "CfattechwomanZ");
	SET_EXTERNAL_SLOT(FILE_CAREA51GUARD, "Carea51guardZ");
	SET_EXTERNAL_SLOT(FILE_CSTRIPES, "CstripesZ");
	SET_EXTERNAL_SLOT(FILE_CBONDALPSZ, "CbondalpsZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_BONDALPSZ, "Ghand_bondalpsZ");
	SET_EXTERNAL_SLOT(FILE_CBONDRANCHZ, "CbondranchZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_BONDRANCHZ, "Ghand_bondranchZ");
	SET_EXTERNAL_SLOT(FILE_CHEADGALOREZ, "CheadgaloreZ");
	SET_EXTERNAL_SLOT(FILE_CGALOREPLANEZ, "CgaloreplaneZ");
	SET_EXTERNAL_SLOT(FILE_CGALORERANCHZ, "CgaloreranchZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_GALORERANCHZ, "Ghand_galoreranchZ");
	SET_EXTERNAL_SLOT(FILE_CHEADSOGUNZ, "CheadsogunZ");
	SET_EXTERNAL_SLOT(FILE_CSOGUNTRONZ, "CsoguntronZ");
	SET_EXTERNAL_SLOT(FILE_GHAND_SOGUNTRONZ, "Ghand_soguntronZ");
	SET_EXTERNAL_SLOT(FILE_CHEADJONATHAN, "CheadjonathanZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMURCHIE, "CheadmurchieZ");
	SET_EXTERNAL_SLOT(FILE_CNATALYA_XMASZ, "Cnatalya_xmasZ");
	SET_EXTERNAL_SLOT(FILE_CNATALYA_ELFZ, "Cnatalya_elfZ");
	SET_EXTERNAL_SLOT(FILE_CHEADDAVEDZ, "CheaddavedZ");
	SET_EXTERNAL_SLOT(FILE_CHEADDAVED2Z, "Cheaddaved2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADBALACLAVAZ, "CheadbalaclavaZ");
	SET_EXTERNAL_SLOT(FILE_CHEADDWAYNEZ, "CheaddwayneZ");
	SET_EXTERNAL_SLOT(FILE_CHEADKARLZ, "CheadkarlZ");
	SET_EXTERNAL_SLOT(FILE_CHEADKARL2Z, "Cheadkarl2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADMARTINZ, "CheadmartinZ");
	SET_EXTERNAL_SLOT(FILE_CHEADMARK0Z, "Cheadmark0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADDUNCAN0Z, "Cheadduncan0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADDUNCAN01Z, "Cheadduncan01Z");
	SET_EXTERNAL_SLOT(FILE_CHEADJONES0Z, "Cheadjones0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADGRANT0Z, "Cheadgrant0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADROBIN0Z, "Cheadrobin0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADGRAEMEZ, "CheadgraemeZ");
	SET_EXTERNAL_SLOT(FILE_CHEADGRAEME2Z, "Cheadgraeme2Z");
	SET_EXTERNAL_SLOT(FILE_CHEADSTEVE_EZ, "Cheadsteve_eZ");
	SET_EXTERNAL_SLOT(FILE_CHEADKEN0Z, "Cheadken0Z");
	SET_EXTERNAL_SLOT(FILE_CHEADEVILCYBORGZ, "CheadevilcyborgZ");
	SET_EXTERNAL_SLOT(FILE_CEVILCYBORGZ, "CevilcyborgZ");

#undef SET_EXTERNAL_SLOT
#endif
}
