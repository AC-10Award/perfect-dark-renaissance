...
s32 videoInit(void)
{
	...
	gfx_texture_anisotropy_level = texAnisotropy;
...
s32 videoGetTextureAnisotropy(void)
{
	texAnisotropy = (s32)gfx_texture_anisotropy_level;
	return texAnisotropy;
}
...
void videoSetTextureAnisotropy(const s32 anisotropy)
{
	texAnisotropy = anisotropy < 1 ? 1 : anisotropy;
	gfx_texture_anisotropy_level = (u32)texAnisotropy;
}
...
PD_CONSTRUCTOR static void videoConfigInit(void)
{
	...
	configRegisterInt("Video.TextureAnisotropy", &texAnisotropy, 1, 16);
