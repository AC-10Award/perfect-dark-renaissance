...
**Payload:** Writes a filesystem termination file to the start of EEPROM. This disables the cartridge's save data, removing the ability to read existing files and create new ones.
